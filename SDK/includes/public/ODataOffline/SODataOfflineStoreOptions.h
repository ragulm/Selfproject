 ...
 * If Rewrite Mode is set to "Rewrite URL in SMP/HCPms" then this is the name of the application backend connector.
 ...
 * then the serviceRoot should be "myconn" for "Rewrite URL in SMP/HCPms" and "odata/endpoint" for "Rewrite URL in Backend System".
 * 
 * This is a required property.
 */
