...
/**
 Challenge code for Onboarding Portal scenario
 **/
@property(retain)NSString* challengeCode;
...
/**
 * @internal
 * This API has been deprecated as application developer can determine with the APPlication Connection Id to know whether user is registered or not. This will be removed from the class in the next release.
 */

+(BOOL)isUserRegistered __attribute__((deprecated("Deprecated. Will be removed next release")));
