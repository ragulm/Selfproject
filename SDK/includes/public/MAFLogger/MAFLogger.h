...
typedef enum {
    ...
    MAFLoggerFile = 4,
    MAFLoggerDelegate = 8
} MAFLoggerTypes __deprecated_enum_msg("The MAFLogger library is deprecated and it will be discontinued in a future release . Please use Supportability instead.");
