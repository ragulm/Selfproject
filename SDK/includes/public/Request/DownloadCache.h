 ...
 */
+ (BOOL)serverAllowsResponseCachingForRequest:(Request *)request DEPRECATED_MSG_ATTRIBUTE("Download cache functionality has been disabled due to security reasons");
...
@property (assign, nonatomic) ECachePolicy defaultCachePolicy DEPRECATED_MSG_ATTRIBUTE("Download cache functionality has been disabled due to security reasons");
