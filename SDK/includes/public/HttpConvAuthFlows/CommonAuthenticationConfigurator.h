...
#import "OAuth2SupportProtocol.h"
 ...
 */
-(void) addOAuth2SupportProvider:(id<OAuth2SupportProtocol>) oauth2SupportProvider;
...
/**
 Adds OTPConfigProviderProtocol implmentation.
 @param otpConfigProvider
 */
