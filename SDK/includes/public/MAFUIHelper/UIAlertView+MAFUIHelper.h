 ...
 */
+ (id)alertViewWithTitle:(NSString *)title message:(NSString *)message resultBlock:(AlertViewResultBlockType)block cancelButtonTitle:(NSString *)cancelButtonTitle otherButtonTitles:(NSString *)otherButtonTitles, ... NS_REQUIRES_NIL_TERMINATION DEPRECATED_ATTRIBUTE;
